            ...
            <table border="1">
              <tbody>
                ...
                <tr style="height: 70px">
                  ...
                  <td><center>
                   <form action="../sql/c_descri_sql.php" method="post"><textarea style="width: 300px;" rows="4" type="text" name="des"></textarea>  <input style="object-position: center;" type="submit" name="guardar" value="Guardar"></form></center></td>
