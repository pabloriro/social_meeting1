            ...
            <table border="1">
              <tbody>
                ...
                <tr style="height: 70px">
                  ...
                  <td style="width: 400px"><center><form action="../sql/c_rut_sql.php" method="post"><input type="text" name="rute">  <input type="submit" name="guardar" value="Guardar"></form></center></td>
