            ...
            <table border="1">
              <tbody>
                ...
                <tr style="height: 70px">
                  ...
                  <td style="width: 400px"><center><form action="../sql/c_dire_sql.php" method="post"><input style="width: 270px" type="text" name="dire"> <input type="submit" name="guardar" value="Guardar"></form></center></td>
