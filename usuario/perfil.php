            ...
            <table border="1">
              <tbody>
                <tr style="height: 120px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_foto.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_pais.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                 <td style="width: 100px">Rubro: </td>
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_rubro.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_tipo.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_rut.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_dire.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_sitio.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_fono.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_mail.php"> Eliminar</a></td>
                </tr>
                <tr style="height: 70px">
                  <td style="width: 100px">Descripción: </td>
                  <td style="width: 700px"><center>
                    <?php 
                      $user = $_SESSION['id_us'];
                      $sql= "SELECT * FROM datos WHERE id_usuario = $user";
                  ...
                  <td style="width: 100px"><a href="../sql/borrar_descri.php"> Eliminar</a></td>
                </tr>
              </tbody>
            </table>
