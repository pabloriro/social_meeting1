              ...
              <tbody>
                <tr style="height: 120px">
                  ...
                  <td style="width: 100px"><center>
                   <form action="../sql/c_foto_sql.php" method="post" enctype="multipart/form-data"><input type="file" name="foto"> <input type="submit" name="guardar" value="Guardar"></form></center></td>
