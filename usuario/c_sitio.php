            ...
            <table border="1">
              <tbody>
                <tr style="height: 120px">
                  ...
                  <td style="width: 100px"><a href="../sql/borrar.php"> Eliminar</a></td>
                </tr>
                ...
                <tr style="height: 70px">
                  ...
                  <td style="width: 400px"><center><form action="../sql/c_sitio_sql.php" method="post"><input style="width: 270px" type="text" name="sit"> <input type="submit" name="guardar" value="Guardar"></form></center></td>
