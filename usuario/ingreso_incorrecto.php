                  ...
                  <tr>
                    <td style="vertical-align: top;">
                      <center><br><input style="font-family: Verdana"; name="guardar" value="Guardar" type="submit"><br><br>
                        <a href="../index.php"><input style="font-family: Verdana"; name="volver" value="Volver a Inicio" type="button"></a><br><br><h3>Tus datos no fueron ingresados correctamente, intentalo de nuevo.</h3></center>
                    </td>
                  </tr>
                  </tbody>
              </table>
