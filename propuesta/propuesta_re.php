				...
				<table bgcolor="white" ; style="width:100%; height: 100%; border-collapse: collapse;">
					<tbody>
						<?php 
				                      ...
				                      $user = $_GET['pd'];
				                      $sql= "SELECT a.nombre, (SELECT a.nombre
										FROM usuario a, propuestas b
										WHERE a.id_usuario=b.dest
										and b.id_propuesta=$user) AS 'nombre2', b.nombrep, b.presentacion, b.pro_ne, b.equipo, b.clientes, b.refe, b.tiempo, b.plazo, b.fech from usuario a, propuestas b where a.id_usuario = b.id_usuario and b.id_propuesta = $user";
						...
						<tr>
							...
							<td style="width: 80%"><center><h3>Propuesta para <?php echo $nombrer; ?></h3></center></td>
							<td style="width: 10%"></td>
						</tr>
						<tr>
							<td></td>
