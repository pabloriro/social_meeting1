...
<html>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css"/>    <title></title>
  </head>
          ...
          <table style="text-align: center; width: 100%;" cellspacing="2" cellpadding="2" border="0">
            <tbody>
              ...
              <tr>
                ...
                <form id="form_buscar" method="post" action="busqueda/result_busqueda.php" onsubmit="return validarbuscar()">
